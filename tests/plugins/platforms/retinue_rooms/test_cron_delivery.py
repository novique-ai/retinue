"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_cron_delivery.py.
...
from plugins.platforms.retinue_rooms.test_cron_delivery import *  # noqa: F401,F403
