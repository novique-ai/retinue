"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_principal.py.
...
from plugins.platforms.retinue_rooms.test_principal import *  # noqa: F401,F403
