"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_cron_api.py.
...
from plugins.platforms.retinue_rooms.test_cron_api import *  # noqa: F401,F403
