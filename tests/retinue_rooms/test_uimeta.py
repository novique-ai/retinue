"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_uimeta.py.
...
from plugins.platforms.retinue_rooms.test_uimeta import *  # noqa: F401,F403
