"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_turn_visibility.py.
...
from plugins.platforms.retinue_rooms.test_turn_visibility import *  # noqa: F401,F403
