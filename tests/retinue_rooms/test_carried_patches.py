"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_carried_patches.py.
...
from plugins.platforms.retinue_rooms.test_carried_patches import *  # noqa: F401,F403
