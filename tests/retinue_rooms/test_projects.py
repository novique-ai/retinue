"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_projects.py.
...
from plugins.platforms.retinue_rooms.test_projects import *  # noqa: F401,F403
