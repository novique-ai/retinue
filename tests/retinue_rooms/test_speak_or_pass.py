"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_speak_or_pass.py.
...
from plugins.platforms.retinue_rooms.test_speak_or_pass import *  # noqa: F401,F403
