"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_voice.py.
...
from plugins.platforms.retinue_rooms.test_voice import *  # noqa: F401,F403
