"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_ide_fence.py.
...
from plugins.platforms.retinue_rooms.test_ide_fence import *  # noqa: F401,F403
