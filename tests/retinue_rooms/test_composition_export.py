"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_composition_export.py.
...
from plugins.platforms.retinue_rooms.test_composition_export import *  # noqa: F401,F403
