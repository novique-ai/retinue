"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_itinerary.py.
...
from plugins.platforms.retinue_rooms.test_itinerary import *  # noqa: F401,F403
