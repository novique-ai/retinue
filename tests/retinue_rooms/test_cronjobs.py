"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_cronjobs.py.
...
from plugins.platforms.retinue_rooms.test_cronjobs import *  # noqa: F401,F403
