"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_crossroom.py.
...
from plugins.platforms.retinue_rooms.test_crossroom import *  # noqa: F401,F403
