"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_invite.py.
...
from plugins.platforms.retinue_rooms.test_invite import *  # noqa: F401,F403
