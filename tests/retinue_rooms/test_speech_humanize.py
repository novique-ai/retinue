"""Collector shim — real tests live at plugins/platforms/retinue_rooms/test_speech_humanize.py.
...
from plugins.platforms.retinue_rooms.test_speech_humanize import *  # noqa: F401,F403
