"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_member_skills.py.
...
from plugins.platforms.retinue_rooms.test_member_skills import *  # noqa: F401,F403
