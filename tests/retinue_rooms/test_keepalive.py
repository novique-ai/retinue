"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_keepalive.py.
...
from plugins.platforms.retinue_rooms.test_keepalive import *  # noqa: F401,F403
