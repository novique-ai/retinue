"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_web_cron_contract.py.
...
from plugins.platforms.retinue_rooms.test_web_cron_contract import *  # noqa: F401,F403
