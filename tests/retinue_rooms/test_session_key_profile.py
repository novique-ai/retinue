"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_session_key_profile.py.
...
from plugins.platforms.retinue_rooms.test_session_key_profile import *  # noqa: F401,F403
