"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_needs_user.py.
...
from plugins.platforms.retinue_rooms.test_needs_user import *  # noqa: F401,F403
