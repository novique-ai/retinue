"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_hidden_sessions.py.
...
from plugins.platforms.retinue_rooms.test_hidden_sessions import *  # noqa: F401,F403
