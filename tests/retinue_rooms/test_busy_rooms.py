"""Collector shim for issue #145 — real tests live at plugins/platforms/retinue_rooms/test_busy_rooms.py.
...
from plugins.platforms.retinue_rooms.test_busy_rooms import *  # noqa: F401,F403
