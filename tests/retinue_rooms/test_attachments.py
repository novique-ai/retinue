"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_attachments.py.
...
from plugins.platforms.retinue_rooms.test_attachments import *  # noqa: F401,F403
