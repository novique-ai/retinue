"""Collector shim for issue #6 — real tests live at plugins/platforms/retinue_rooms/test_workspace.py.
...
from plugins.platforms.retinue_rooms.test_workspace import *  # noqa: F401,F403
